 ...
 */
public class RotaryBallView extends View {
    ...
    public RotaryBallView(Context context) {
        this(context, null);
    }

    public RotaryBallView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RotaryBallView(Context context, AttributeSet attrs, int defStyleAttr) {
