 ...
 * 两个小球循环旋转dialog
 */
public class RotaryBallLoadingProgressDialog extends View {
     ...
     * @param context
     */
    public RotaryBallLoadingProgressDialog(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public RotaryBallLoadingProgressDialog(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public RotaryBallLoadingProgressDialog(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * View的visibility发生改变时，引发执行onVisibilityChanged方法中的动作
     * @param changedView
     * @param v
     */
    @Override
